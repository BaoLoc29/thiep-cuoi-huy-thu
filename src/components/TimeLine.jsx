  ...
  return (
    <section className="text-center flex flex-col justify-center items-center overflow-hidden p-4">
      ...
      <div ref={ceremony.ref}>
        ...
        `}
        >
          <p>(Tức ngày 19 tháng 8 năm Bính Ngọ)</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="w-full bg-gray-200 rounded-3xl py-6">
          ...
          <p className="text-base mb-0 px-5">
            18 Tôn Đức Thắng, Tân Châu, An Giang
          </p>
          <div className=" p-4 overflow-hidden rounded-md">
            <iframe
              title="Địa điểm tổ chức lễ cưới"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3546.6518451537536!2d105.24926657451743!3d10.797676658802471!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310a30684e04e6ad%3A0x9068d796ec330d53!2zMTggxJDGsOG7nW5nIFTDtG4gxJDhu6ljIFRo4bqvbmcsIFTDom4gQ2jDonUsIEFuIEdpYW5nLCBWaeG7h3QgTmFt!5e1!3m2!1svi!2s!4v1790258865640!5m2!1svi!2s"
          ...
          <div className="mt-2 flex justify-center">
            <a
              href="https://maps.app.goo.gl/yB9GwCVWtpGpSx6TA"
              target="_blank"
